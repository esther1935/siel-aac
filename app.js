...
async function registerServiceWorker() {
  ...
  try {
    await navigator.serviceWorker.register("./sw.js?v=sielResponsiveCategory20260628");
    updateSyncStatus();
  } catch (e) {
...
async function initFirebase() {
  try {
    const configModule = await import("./firebase-config.js?v=sielResponsiveCategory20260628");
